...
export default class extends think.Service {
    constructor() {
        ...
        this
            .caseModel
            .belongsTo(this.userModel, {foreignKey: 'create_by'})
        this
            .userModel
        ...
        this
            .caseModel
            .belongsTo(this.hi_procinstModel, {foreignKey: 'proc_inst_id'})
        this
            .hi_procinstModel
    ...
    WHERE a.id IN ${data.orgList} GROUP BY a.id`;
        try {
            ...
            const list = await this
                .db
                .sequelize
                .query(sql, {type: this.db.sequelize.QueryTypes.SELECT});
            return list;
        } catch (err) {
            return this
                .exceptionService
