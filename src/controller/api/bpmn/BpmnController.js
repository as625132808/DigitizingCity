...
export default class  extends think.BaseSocket {
    ...
    async submitFormAction() {
        ...
        this.sendMsgByUserAction(res.socketBody, res.userIds, 'msg_box');
        } else {
            aj.success = false;
            aj.msg = '提交失败';
        }
        ...
        try {
            ...
            if (!res.error) {
                ...
                if (res.backObj.userIds.length > 0) {
                    ...
                    this.sendMsgByUserAction(socketBody, res.backObj.userIds, 'control_center');
                    socketBody.menuUrl='myTask'
                    this.sendMsgByUserAction(socketBody, res.backObj.userIds, 'msg_box');
                }
                ...
                this.sendMsgByUserAction(socketBody1, res.createObj.userIds, 'msg_box');
